...
public class UsuarioRepositoryTest {
	...
	void start(){
		...
		LocalDate data = LocalDate.parse("1996-05-13", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
		
		Usuario usuario = new Usuario(0, "João da Silva", "joca@email.com.br", "78596423", data);
